...
(function () {
	...
	// write an extension to backbone model
	Forecast = Backbone.Model.extend({
		...
		parse: function (data, request) {
			...
			return {
				...
				state: obseration.display_location.state_name,
	...
	Forecast = Backbone.Collection.extend({
		model: Forcast
	});
